...
Share.statics.create = function (fromAddress, toAddress, price, bucketEntryId, fileName, key, crt, fileSize, callback) {
    const Share = this;
    ...
    if (!crt) {
        return callback(new errors.BadRequestError('"crt" is necessary to create a new share.'));
    }
